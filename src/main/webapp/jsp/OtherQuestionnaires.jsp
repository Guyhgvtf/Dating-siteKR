...
<head>
    ...
    <script>
        ...
        function skipProfile(action) {
            ...
            xhr.open("GET", "NextProfileServlet?index=" + currentIndex + "&action=" + action + "&profileToken=" + currentProfileToken, true);
...
<%
    ...
    if (token != null) {
        ...
        List<Profile> profiles = filter.getFilteredProfiles(token);
